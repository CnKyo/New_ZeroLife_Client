...
-(void) initTableView
{
    ...
    HlineView.backgroundColor = [UIColor colorWithRed:0.89 green:0.89 blue:0.89 alpha:1.00];
    ...
    _mainTableView.separatorColor =  [UIColor colorWithRed:0.89 green:0.89 blue:0.89 alpha:1.00];
...
-(void)standardBtnClick:(UIButton *)sender
{
    ...
    int mId = [[NSString stringWithFormat:@"%@",tagStr] intValue]-100;
    ...
    {
        [self.delegate Standards:self SelectBtnClick:sender andSelectID:[NSString stringWithFormat:@"%d",mId] andStandName:self.standardArr[(sender.tag & 0x0000ffff)-100].standardName andIndex:(sender.tag & 0x0000ffff)-100];
    }
