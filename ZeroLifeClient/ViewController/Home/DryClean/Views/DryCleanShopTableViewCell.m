...
- (void)setMShopObj:(ZLShopHomeShopObj *)mShopObj{
    ...
    [self.iconImgView sd_setImageWithURL:[NSURL URLWithString:[Util currentSourceImgUrl:mShopObj.shop_logo]] placeholderImage:[UIImage imageNamed:@"ZLDefault_Green"]];
