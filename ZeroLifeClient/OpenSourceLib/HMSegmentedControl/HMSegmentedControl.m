...
- (instancetype)initWithSectionImages:(NSArray *)sectionImages sectionSelectedImages:(NSArray *)sectionSelectedImages titlesForSections:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.showType = HMSegmentedControlTextImagesShowType_ImageTop;
    }
...
- (void)commonInit {
    ...
    self.showType = HMSegmentedControlTextImagesShowType_TextTop;
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == HMSegmentedControlTypeText) {
		...
		[self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            ...
            if (_showType == HMSegmentedControlTextImagesShowType_TextTop) {
                ...
                imageRect = CGRectMake(imageXOffset, imageYOffset, imageWidth, imageHeight);
                textRect = CGRectMake(textXOffset, yOffset, textWidth, stringHeight);
            } else if (_showType == HMSegmentedControlTextImagesShowType_ImageTop) {
                imageYOffset = 5;
                yOffset = imageHeight + imageYOffset + 3;
                imageRect = CGRectMake(imageXOffset, imageYOffset, imageWidth, imageHeight);
                textRect = CGRectMake(textXOffset, yOffset, textWidth, stringHeight);
            }
