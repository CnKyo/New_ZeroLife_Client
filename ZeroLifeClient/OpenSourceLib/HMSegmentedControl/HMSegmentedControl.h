...
typedef NS_ENUM(NSInteger, HMSegmentedControlTextImagesShowType) {
    HMSegmentedControlTextImagesShowType_TextTop,
    HMSegmentedControlTextImagesShowType_ImageTop
};
...
@property (nonatomic, assign) HMSegmentedControlTextImagesShowType showType;
